...
<body>
    ...
    <section>
        <form action="acaotriangulo.php" method='post'>
            ...
            <input readonly type="text" name='id' id='id' value='<?php if($acao == 'editar') echo $dados['idtriangulo']; else echo 0; ?>'>
            ...
            <input type="text" name='lado3' id='lado3' value='<?php if($acao == 'editar') echo $dados['lado3']; ?>'>
    ...
    <div style='height:70vw'>
        <?php
            ...
            foreach($lista as $item){
                ...
                echo '<a draggable="true" href="index.php?acao=editar&id='.$t->getId().'">';
                echo $t->desenhar();
                echo '</a>';
            }
        ?>
